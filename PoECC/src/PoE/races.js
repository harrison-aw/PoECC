...
import {Indexes} from './attributes';
import * as Abilities from './abilities';

class PoERace {
  constructor(name, description, attributes, subraces, shape=null) {
    this.name = name;
    this.description = description;
    this.attributes = Indexes.map((i) => typeof attributes[i] !== 'undefined' ? attributes[i] : 0);
